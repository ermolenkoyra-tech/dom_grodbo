...
def price_ok(text):
    """
    ищем цену в BYN (очень грубый, но рабочий вариант)
    """
    numbers = re.findall(r"\d[\d\s]{4,}", text.replace("\xa0", " "))
    ...
    # если цены вообще нет — не блокируем
    return True
